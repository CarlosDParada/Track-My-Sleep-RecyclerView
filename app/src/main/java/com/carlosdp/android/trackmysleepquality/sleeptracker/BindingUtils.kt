...
import com.carlosdp.android.trackmysleepquality.convertDurationToFormatted
...
@BindingAdapter("sleepImageSetter")
fun ImageView.setSleepImageSetter(item: SleepNight?){
    item?.let {
